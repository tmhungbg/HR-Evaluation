...
staffs = [
  ...
  {name: "Le Viet Ha",          email:"vietha@mmj.vn",  job:"manager",         is_supervisor: false, is_senior: true, supervisor_id: 1},
  {name: "Tomoya Endo",         email:"tendo@mmj.ne.jp",job:"tester",          is_supervisor: false, is_senior: true, supervisor_id: 1},
  {name: "Nguyen Van Hao",      email:"hao@mmj.vn",     job:"developer",       is_supervisor: false, is_senior: true, supervisor_id: 1},
  ...
  {name: "Tran Duy Duong",      email:"duong@mmj.vn",   job:"developer",       is_supervisor: false, is_senior: true, supervisor_id: 2},
